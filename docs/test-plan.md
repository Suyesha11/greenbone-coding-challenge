...
| 2 | TC04 | P1 - Critical | Direct URL access bypassing login is a security vulnerability. The app must redirect to login and show "Epic sadface: You can only access '/inventory.html' when you are logged in." critical for any application handling user data or purchases. |
